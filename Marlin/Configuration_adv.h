...
#define HOMING_BUMP_DIVISOR { 2, 2, 18 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 15*60, 100 } // Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  // Note: this values cannot be calibrated and have to be set manually
    ...
    #define PTC_PARK_POS_X 250
    #define PTC_PARK_POS_Y 210
    #define PTC_PARK_POS_Z 100

    // Probe position to probe and wait for probe to reach target temperature
    #define PTC_PROBE_POS_X  125
    #define PTC_PROBE_POS_Y 105
